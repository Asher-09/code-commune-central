...
-- 3. Events table (created_by can be null initially)
...
-- Insert sample events (without created_by for now)
INSERT INTO public.events (title, description, event_date, location, max_participants) VALUES
  ('React Workshop', 'Learn modern React development techniques and best practices', '2024-09-15 14:00:00+00', 'Tech Hub Room A', 30),
  ('AI/ML Seminar', 'Introduction to Machine Learning and AI applications', '2024-09-22 16:00:00+00', 'Main Auditorium', 50),
  ('Hackathon Kickoff', 'Start of our annual 48-hour coding challenge', '2024-10-01 09:00:00+00', 'Innovation Lab', 100);

-- Insert sample admin profile (without user_id for now) 
INSERT INTO public.admins (name, role, bio, expertise, achievements, social_links) VALUES
  ('Sarah Johnson', 'Club President', 'Passionate about technology and community building', 
   ARRAY['JavaScript', 'React', 'Node.js', 'Leadership'], 
   ARRAY['Led 50+ workshops', '3x Hackathon winner', 'Google Developer Expert'],
   '{"github": "sarahjdev", "linkedin": "sarahjohnson", "twitter": "sarahtech"}'::jsonb),
  ('Mike Chen', 'Technical Lead', 'Full-stack developer with 5+ years experience', 
   ARRAY['Python', 'Django', 'PostgreSQL', 'DevOps'], 
   ARRAY['Published 10+ open source projects', 'AWS Certified Solutions Architect'],
   '{"github": "mikechen", "linkedin": "mikechendev"}'::jsonb),
  ('Alex Rivera', 'Event Coordinator', 'Specializes in organizing tech events and workshops', 
   ARRAY['Event Management', 'Public Speaking', 'Community Outreach'], 
   ARRAY['Organized 100+ events', 'TEDx Speaker'],
   '{"linkedin": "alexrivera", "twitter": "alexevents"}'::jsonb);